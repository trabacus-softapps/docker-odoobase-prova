...
run minimal_apt_get_install chrpath libssl-dev libxft-dev libfreetype6-dev libfreetype6 libfontconfig1-dev libfontconfig1 unzip openjdk-8-jre-headless xvfb libxi6 libgconf-2-4
